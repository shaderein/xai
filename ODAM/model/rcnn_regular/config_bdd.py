...
class COCO:
    root_folder = './data/bdd100k'
    train_folder = os.path.join(root_folder, 'images/100k/train')
    eval_folder = os.path.join(root_folder, 'images/100k/val')
    test_folder = os.path.join(root_folder, 'images/100k/test')
    train_source = os.path.join(root_folder,'labels/det_20_coco/det_train_coco.json')
    eval_source = os.path.join(root_folder,'labels/det_20_coco/det_val_coco.json')
