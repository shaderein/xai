...
# input path
images_path = '/mnt/h/Projects/HKU_XAI_Project/Yolov5self_GradCAM_Pytorch_1/orib_veh_id_task0922'

# Whole-image Attention Maps
human_attention_path = '/mnt/h/OneDrive - The University Of Hong Kong/bdd/attention_maps/231206 Veh DET/whole_image'

# Output path
plot_path = '/mnt/h/OneDrive - The University Of Hong Kong/bdd/attention_maps/231206 Veh DET/visualize_test'
...
for file in os.listdir(human_attention_path):
    ...
    human_attention[img_idx] = map

    # Visualize
    img_path = os.path.join(images_path, f'{img_idx}.jpg')
    img = cv2.imread(img_path)

    # Plot saliency maps
    res_img_whole, _ = get_res_img(map, img.copy())

    final_image = res_img_whole*255
    cv2.imwrite(os.path.join(plot_path,f"{img_idx}.jpg"), final_image)