...
def combine_images(root_dir, target_img_name, ext):
    ...
    plt.tight_layout()
    plt.savefig(f"results/visualizations/{model}_{root_dir.split('/')[-1]}_{target_img_name}.png")
...
root_dir = "/mnt/h/jinhan/results/mscoco/xai_saliency_maps_faster_gaussian_sigma4/fullgradcamraw"
target_img_name = 'chair_81061'
ext = 'png'
combine_images(root_dir,target_img_name,ext)
