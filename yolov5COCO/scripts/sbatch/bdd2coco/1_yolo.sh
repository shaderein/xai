...
#SBATCH --job-name=1_yolo                # Slurm job name
...
for category in vehicle human; do
    ...
    python main_faithful_cal_adaptive_yolo_optimize_faithfulness_bdd2coco.py --object $category --img-start 0 --img-end 40 --device 0
