...
#SBATCH --job-name=3_yolo                # Slurm job name
...
for category in vehicle human; do
    ...
    python main_faithful_cal_adaptive_yolo_optimize_faithfulness_bdd2coco.py --object $category --img-start 80 --img-end 120 --device 0
