...
def main(img_path, label_path, model, saliency_method, img_num, 
    ...
    for sigma_factor in masks_all:
        ...
        masks = activations_all[sigma_factor]
        masks_sum = activations_sum_all[sigma_factor]
...
if __name__ == '__main__':
    ...
    if args.object == "COCO":
        ...
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/unnorm_raw_act/mscoco/xai_saliency_maps_yolov5s_gaussian_sigmaFACTOR/fullgradcamraw"
        ...
        args.method = "fullgradcamraw"
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/unnorm_raw_act/bdd/xai_saliency_maps_yolov5s_gaussian_sigmaFACTOR/fullgradcamraw_vehicle"
        ...
        args.method = "fullgradcamraw"
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/unnorm_raw_act/bdd/xai_saliency_maps_yolov5s_gaussian_sigmaFACTOR/fullgradcamraw_human"
    ...
    for i, (target_layer_group_name,layer_param) in enumerate(flatten_layers.items()):
        ...
        # if not any([l for l in ['model_9','model_10','model_14','model_13','model_17'] if l in target_layer_group_name]): continue
