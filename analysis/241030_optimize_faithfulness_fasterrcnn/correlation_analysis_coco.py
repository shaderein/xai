...
logging.basicConfig(filename='/home/jinhanz/cs/xai/logs/241030_fasterrcnn_correlation_process_coco_optimize_faithfulness_.log', 
                    level=logging.INFO,
...
for is_act in ["xai_saliency","activation"]:
    for rescale_method in ['bilinear']:
        ...
        xai_saliency_path = {
            "FullGradCAM":f'/opt/jinhanz/results/bilinear/mscoco/{is_act}_maps_fasterrcnn/fullgradcamraw',
            "ODAM":f'/opt/jinhanz/results/bilinear/mscoco/{is_act}_maps_fasterrcnn/odam',
        }
        ...
        save_dir = f'/home/jinhanz/cs/xai/results/mscoco/241030_bilinear_{is_act}_maps_fasterrcnn'
