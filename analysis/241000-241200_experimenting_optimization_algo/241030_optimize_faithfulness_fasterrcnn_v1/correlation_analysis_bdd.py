...
logging.basicConfig(filename='/home/jinhanz/cs/xai/logs/241030_correlation_process_bilinear.log', 
                    level=logging.INFO,
...
for object in ['human']:
    ...
    for is_act in ["xai_saliency","activation"]:
        for rescale_method in ['optimize_faithfulness']:
            ...
            save_dir = f'/home/jinhanz/cs/xai/results/bdd/241111_optimize_faithfulness_{is_act}_maps_fasterrcnn'
