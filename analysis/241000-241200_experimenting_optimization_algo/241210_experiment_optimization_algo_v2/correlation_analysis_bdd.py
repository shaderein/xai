...
for object in ['vehicle','human']:
    ...
    for is_act in ["rpn_saliency"]: # "xai_saliency","activation",,"rpn_activation"
        for rescale_method in ['bilinear']: # 'optimize_faithfulness_finer'
            ...
            save_dir = f'/home/jinhanz/cs/xai/results/bdd/241030_{rescale_method}_{is_act}_maps_fasterrcnn'
