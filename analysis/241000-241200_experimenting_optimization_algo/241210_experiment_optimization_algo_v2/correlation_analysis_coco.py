...
for is_act in ["xai_saliency","activation","rpn_saliency","rpn_activation"]:
    for rescale_method in ['optimize_faithfulness_finer']:
        ...
        save_dir = f'/home/jinhanz/cs/xai/results/mscoco/241210_{rescale_method}_{is_act}_maps_fasterrcnn'
