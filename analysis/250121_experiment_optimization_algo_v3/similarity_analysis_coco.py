...
logging.basicConfig(filename='/home/jinhanz/cs/xai/logs/250105_fasterrcnn_correlation_process_coco_optimize_faithfulness_.log', 
                    level=logging.INFO,
...
for is_act in ["xai_saliency","activation","rpn_saliency",]:
    for rescale_method in ['optimize_faithfulness_finer_v3','bilinear']: # ,
        ...
        xai_saliency_path = {
            "FullGradCAM":f'/opt/jinhanz/results/fasterrcnn/{rescale_method}/mscoco/{is_act}_maps_fasterrcnn/fullgradcamraw',
            "ODAM":f'/opt/jinhanz/results/fasterrcnn/{rescale_method}/mscoco/{is_act}_maps_fasterrcnn/odam',
        }
        ...
        for method, func in similarity_methods.items():
            ...
            save_dir = f'/home/jinhanz/cs/xai/results/mscoco/250121_{rescale_method}_{is_act}_maps_fasterrcnn'
