...
# target_layer_group_list = [
#                            ['model_17_act', 'model_21_act', 'model_25_act'],  # F1
#                            ['model_14_act', 'model_19_act', 'model_23_act'],                    #F2
#                            ['model_13_act', 'model_17_act', 'model_21_act'],                    #F3
#                            ['model_10_act', 'model_14_act', 'model_19_act']]                       #F4
# target_layer_group_name_list = ['F1', 'F2', 'F3', 'F4']

target_layer_group_list = [['model_17_cv3_act', 'model_20_cv3_act', 'model_23_cv3_act']]                       #F1
...
input_main_dir = 'COCO_YOLO_IMAGE'   #Veh_id_img orib_veh_id_task_previous orib_veh_id_task0922
input_main_dir_label = 'COCO_YOLO_LABEL'   #Veh_id_label orib_veh_id_task_previous_label orib_veh_id_task0922_label
output_main_dir = 'COCO_YOLO_IMAGE_yolov5sCOCO_results'

sel_method = 'fullgradcam'  # gradcam, gradcampp, fullgradcam, fullgradcamraw, saveRawGradAct
sel_nms = 'NMS'
sel_prob = 'class'
sel_norm = 'norm'
sel_model = 'yolov5s_COCOPretrained.pt'
sel_model_str = sel_model[:-3]
sel_object = 'COCO'    # human, vehicle
...
def main(img_path, label_path, model, saliency_method, img_num):
    ...
    if sel_faith == 'nofaith':
        ...
        trainedXAI_saliency_map_path = 'E:/HKU/HKU_XAI_Project/Human_Inspired_XAI_Try2/saveRawSaliencyMapData_testSet_GaussianConv_onlyAF/' + img_num + '_trainedSaliencyMap.mat'
