...
import logging
logging.basicConfig(filename='/home/jinhanz/cs/xai/logs/241111_fasterrcnn_bilinear_rpn.log',
                    filemode='a',
...
if __name__ == '__main__':
    ...
    if args.object == "COCO":
        ...
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/bilinear/mscoco/rpn_saliency_maps_fasterrcnn/fullgradcamraw"
        ...
        args.method = "fullgradcamraw"
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/bilinear/bdd/rpn_saliency_maps_fasterrcnn/fullgradcamraw_vehicle"
        ...
        args.method = "fullgradcamraw"
        args.prob = "class"
        args.output_main_dir = "/opt/jinhanz/results/bilinear/bdd/rpn_saliency_maps_fasterrcnn/fullgradcamraw_human"
    ...
    for item_img, item_label in zip(img_list[int(args.img_start):int(args.img_end)], label_list[int(args.img_start):int(args.img_end)]):
        ...
        # if item_img not in sampled_images: continue #DEBUG
