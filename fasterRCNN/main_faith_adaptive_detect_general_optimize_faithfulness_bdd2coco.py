...
if __name__ == '__main__':
    ...
    if args.object == "vehicle":
        ...
        args.prob = "class"
        args.output_main_dir = f"{path_config.get('Paths','result_dir')}/bdd2coco/xai_saliency_maps_fasterrcnn/fullgradcamraw_vehicle"
        ...
        args.method = "fullgradcamraw"
        args.prob = "class"
        args.output_main_dir = f"{path_config.get('Paths','result_dir')}/bdd2coco/xai_saliency_maps_fasterrcnn/fullgradcamraw_human"
        args.coco_labels = f"{path_config.get('Paths','data_dir')}/mscoco/annotations/COCO_classes2.txt"
