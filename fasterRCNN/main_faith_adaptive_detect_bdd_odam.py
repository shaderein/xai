...
target_layer_group_dict = {
    ...
    'proposal_generator.rpn_head.conv.activation':'proposal_generator.rpn_head.conv.activation',
...
def main(arguments, img_path, label_path, target_layer_group, model, cfg, img_num,
        class_names_gt, class_names_sel,category,
        sel_norm="norm"):
    # sel_norm_str = 'norm'
...
if __name__ == '__main__':
    ...
    for category in ["vehicle","human"]:
        if category == "vehicle":
            ...
            output_main_dir = "/mnt/h/OneDrive - The University Of Hong Kong/bdd/xai_saliency_maps_same_layer_faster/odam_vehicle"
        elif category == "human":
            ...
            output_main_dir = "/mnt/h/OneDrive - The University Of Hong Kong/bdd/xai_saliency_maps_same_layer_faster/odam_human"
