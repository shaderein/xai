...
target_layer_group_dict = {
    'backbone.stem.conv1' : 'backbone.stem.conv1',
...
output_main_dir = '/mnt/h/OneDrive - The University Of Hong Kong/mscoco/xai_saliency_maps_faster_rpn/fullgradcamraw'    # _humanAttention _trainedXAI
