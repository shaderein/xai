...
#SBATCH --job-name=3_v25_bdd2coco                # Slurm job name
...
for category in vehicle human; do
    ...
    python main_faith_adaptive_detect_general_optimize_faithfulness_bdd2coco.py --object $category --img-start 80 --img-end 120 --device 0
...
for category in vehicle human; do
    ...
    python main_faith_adaptive_detect_general_optimize_faithfulness_rpn_bdd2coco.py --object $category --img-start 80 --img-end 120 --device 0
