...
#SBATCH --job-name=3_v3_van_rpn                # Slurm job name
...
for category in human vehicle COCO; do
    ...
    python main_faith_adaptive_detect_general_optimize_faithfulness_v3.py --object $category --img-start 80 --img-end 120 --device 0
...
for category in human vehicle COCO; do
    ...
    python main_faith_adaptive_detect_general_optimize_faithfulness_rpn_v3.py --object $category --img-start 80 --img-end 120 --device 0
