...
import logging
logging.basicConfig(filename='/home/jinhanz/cs/xai/logs/241127_optimize_faithfulness_fasterrcnn_finer.log', 
                    filemode='a',
...
def main(img_path, label_path, target_layer_group, 
    ...
    if os.path.exists(os.path.join(args.output_dir.replace('fullgradcamraw','optimization'),f"{img_path.split('/')[-1].split('.')[0]}.json")):
        ...
        for step in range(steps):
            ...
            if faithfulness > best_faithfulness + faithfulness_epsilon:
